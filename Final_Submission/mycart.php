	...
	<div style="margin-top: 20px; padding: 0 10%;">
		...
		$result = mysqli_query($con,"SELECT * FROM user WHERE id='$user'");
			$get_user_email = mysqli_fetch_assoc($result);
				...
				echo '<h3 style="color:#169E8F;font-size:35px;"> Total: '.$_SESSION['total'].' Taka</h2>';
								...
								<form action="" method="POST" class="registration">
									...
									<h3 style="color:red;font-size:18px; padding: 5px;">Accepting CashOnDelivery Only</h3>
										...
										Types of Delivery <br>
										 ...
										 <input name="Delivery" required="required" value="Express Delivery + 100 Taka upon cash on delivery" type="radio"  placeholder="Mode Of Payment"> Express Delivery </br>
